...
var _chalk = __webpack_require__(59);
...
var argv = __webpack_require__(101).argv;
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  _context.next = 3;
                  return _this.executeWebpackComponents();
...
var _semver = __webpack_require__(102);
...
var InjectAsComment = function () {
  ...
  (0, _createClass3.default)(InjectAsComment, [{
    ...
    value: function apply() {
      for (var basename in this.context.compilation.assets) {
        var ext = _path2.default.extname(basename);
        var asset = this.context.compilation.assets[basename];
        switch (ext) {
          case '.js':
        ...
        _log2.default.info('InjectAsComment : match : ' + basename + ' : injected : ' + this.context.version);
      }
    ...
    value: function parseTags(baseOpen, baseClose) {
      ...
      tagPattern = tagPattern.replace(/(\{([a-zA-Z]+)\})/g, function (tag) {
        ...
        if (typeof _tags2.default[tagName] === 'function') {
          return _tags2.default[tagName](_this.context);
        }
    ...
    value: function apply() {
      ...
      for (var basename in this.context.compilation.assets) {
        ...
        if (this.context.config.componentsOptions.InjectByTag.fileRegex.test(basename)) {
          var _ret = function () {
            var replaced = 0;
            var asset = _this.context.compilation.assets[basename];
...
var hasAnsi = __webpack_require__(98);
...
var minimist = __webpack_require__(100);
var wordwrap = __webpack_require__(105);
